...
def build_resunet(input_shape=(768, 1024, 3)):
    inputs = Input(shape=input_shape)

    # Encoder
    c1 = Conv2D(32, 3, activation='relu', padding='same')(inputs)
    c1 = res_block(c1, 32)
    p1 = MaxPooling2D()(c1)  # 384x512

    c2 = Conv2D(64, 3, activation='relu', padding='same')(p1)
    c2 = res_block(c2, 64)
    p2 = MaxPooling2D()(c2)  # 192x256

    c3 = Conv2D(128, 3, activation='relu', padding='same')(p2)
    c3 = res_block(c3, 128)
    p3 = MaxPooling2D()(c3)  # 96x128
